    ...
    return (
      <div className="fixed inset-0 z-50 bg-zinc-950 flex flex-col items-center justify-center" style={{ paddingTop: 'var(--safe-area-top)', paddingBottom: 'var(--safe-area-bottom)' }}>
        <div className="w-full max-w-sm px-6">
          ...
          <h2 className="text-xl font-semibold text-white mb-2 text-center">QR Code Scanned</h2>
          <p className="text-zinc-400 mb-6 text-center">Enter a name for this device</p>
          ...
          <input
            ...
            className="w-full px-4 py-3 bg-zinc-800 border border-zinc-700 rounded-xl text-white placeholder-zinc-500 focus:outline-none focus:border-blue-500 mb-4"
            onKeyDown={(e) => {
      ...
      <div className="flex flex-col items-center justify-center px-8 text-center">
        {isPairing ? (
          <>
            ...
            <h2 className="text-xl font-semibold text-white mb-2">Pairing Device</h2>
          ...
          <>
            ...
            <p className="text-zinc-400 mb-6">
              Run <code className="bg-zinc-800 px-2 py-0.5 rounded text-sm">tunnel-client start</code> on your Mac to display a QR code
            </p>
            <button
              onClick={startScanning}
