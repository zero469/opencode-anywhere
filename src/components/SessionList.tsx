...
export function SessionList({ onClose }: { onClose?: () => void }) {
  ...
  return (
    ...
    >
      ...
      <div 
        className="absolute bottom-0 left-0 right-0 flex justify-center gap-3 px-5 py-3 pointer-events-none"
      >
        {isSearchExpanded ? (
          <div 
            className="flex-1 flex items-center gap-2 pointer-events-auto rounded-2xl px-3 py-2"
            style={{ 
              background: 'var(--glass-bg)',
              backdropFilter: 'blur(20px) saturate(180%)',
              WebkitBackdropFilter: 'blur(20px) saturate(180%)',
          ...
          >
            <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{ color: 'var(--foreground-muted)' }}>
          ...
          <>
            <button
              ...
              className="pointer-events-auto w-12 h-12 rounded-full flex items-center justify-center active:scale-95 transition-transform"
              style={{ 
                background: 'var(--glass-bg)',
                backdropFilter: 'blur(20px) saturate(180%)',
                WebkitBackdropFilter: 'blur(20px) saturate(180%)',
